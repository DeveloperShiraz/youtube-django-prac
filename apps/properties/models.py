...
class Property(TimeStampedUUIDModel):
    ...
    city = models.CharField(verbose_name=_("City"), max_length=180, default="Jersey City")
    postal_code = models.CharField(verbose_name=_("Postal Code"), max_length=100, default="140")
    street_address = models.CharField(verbose_name=_("Street Address"), max_length=150, default="Kearny Ave")
    property_number = models.IntegerField(verbose_name=_("Property Number"), validators=[
                                          MinValueValidator(1)], default=112)
    ...
    plot_area = models.DecimalField(verbose_name=_("Plot Area(m^2)"), max_digits=8, decimal_places=2, default=0.00)
    ...
    bathrooms = models.DecimalField(verbose_name=_("Bathrooms"), max_digits=4, decimal_places=2, default=1.00)
    ...
    photo1 = models.ImageField(default="mediafiles\interior_sample.jpg", null=True, blank=True)
    photo2 = models.ImageField(default="mediafiles\interior_sample.jpg", null=True, blank=True)
    photo3 = models.ImageField(default="mediafiles\interior_sample.jpg", null=True, blank=True)
    photo4 = models.ImageField(default="mediafiles\interior_sample.jpg", null=True, blank=True)
