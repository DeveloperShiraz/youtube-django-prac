...
class Profile(TimeStampedUUIDModel):
    ...
    country = CountryField(verbose_name=("Country"), default="USA", blank=False, null=False)
    city = models.CharField(verbose_name=_("City"), max_length=180, default="New Jersey", blank=False, null=False)
